	   ...
	   <div class="inner-content">
			...
			<!-- top_bg -->
						<div class="top_bg">
								...
								<div class="header_top">
									<div class="top_right">
										<ul>
											<li><a href="contact.html">问卷说明 |</a></li>
											<li><a href="contact.html">问卷类型 |</a></li>
											<li><a href="checkout.html">报表</a></li>
										</ul>
										
									</div>
									<div class="top_left">
										<h2><span></span> <a href =""> 信息反馈 </a></h2>
									</div>
				...
				<div class="header_bg">
							...
							<div class="header">
								<div class="head-t">
													...
													<div id="loginContainer"><a id="loginButton" class=""><span>登录</span></a>
														<div id="loginBox" style="display: none;">                
															<form id="loginForm">
																	<fieldset id="body">
																		<fieldset>
																			  <label for="email">Email或者账号</label>
																			  <input type="text" name="emailOrNumber" id="emailOrNumber" value="不超过20个字符" onmouseover=this.focus();this.select();   
									...
									<div class="search">
										<form>
											<input type="text" value="search for..." onmouseover=this.focus();this.select();   
		         																 onclick="if(value==defaultValue){value='';this.style.color='#000'}"   
		         																 onBlur="if(!value){value=defaultValue;this.style.color='#999'}" style="color:#999">
		...
		<div class="fo-top-di">
			...
			<div class="footer">
					...
					<div class="clearfix"> </div>
						<p>Copyright &copy; 2016.Company name All rights reserved.<a target="_blank" href="http://www.mobanpai.com/moban/">&#x7F51;&#x9875;&#x6A21;&#x677F;</a></p>
			</div>
		</div>
			</div>
			<!--content-->
                           ...
                           <div class="menu">
									<ul id="menu" >
										<li><a href="index.html"><i class="fa fa-tachometer"></i> <span>首页</span></a></li>
										 <li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span> 选择题</span> <span class="fa fa-angle-right" style="float: right"></span></a>
